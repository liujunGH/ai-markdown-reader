...
import type { MissingWikiLink } from '../../utils/wikiGraph'
...
export function MissingLinksPanel({ links, folderPath, onCreateFile, onOpenSource, onClose }: Props) {
        ...
        <div className={styles.content}>
          {links.length === 0 ? (
            ...
            <div className={styles.list}>
              {links.map(link => (
                <article key={link.normalizedTarget} className={styles.item}>
