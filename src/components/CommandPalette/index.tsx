...
const DEFAULT_COMMANDS: Command[] = [
  ...
  { id: 'toggle-focus', label: '专注模式', shortcut: 'Ctrl+.', category: '阅读', icon: '👁️', action: () => {} },
  ...
  { id: 'quick-jump', label: '快速跳转', shortcut: 'Ctrl+G', category: '查找与导航', icon: '↗', action: () => {} },
  { id: 'file-info', label: '文件信息', category: '视图', icon: 'ℹ️', action: () => {} },
  { id: 'reading-timeline', label: '阅读时间线', category: '阅读', icon: '◷', action: () => {} },
  { id: 'reading-tools', label: '阅读工具', category: '阅读', icon: '◫', action: () => {} },
  { id: 'export-reading-backup', label: '导出阅读数据备份', category: '高级', icon: '⇩', action: () => {} },
  { id: 'import-reading-backup', label: '导入阅读数据备份', category: '高级', icon: '⇧', action: () => {} },
